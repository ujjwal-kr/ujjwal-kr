...
- Wroking on a [in-memory DB](https://github.com/ujjwal-kr/appledore) compatible with redis with more minimal and specific features, for use in the hackarmour search engine.
