...
- **[Kamui](https://github.com/ujjwal-kr/kamui)**: Bidirectional TCP proxy for security related stuff.
- **[Nice Try](https://github.com/ujjwal-kr/nice-try)**: [WIP] A silly AI Agent to convert natural language cyber threats into corporate terms.  
