...
- It uses modern Javascript APIs to intentify your metadata and keeps the information in a cookie, and then encypts it.
...
- I may create dummy marketing services to demonstrate the (personalized ads) tracking process close to the realworld.
